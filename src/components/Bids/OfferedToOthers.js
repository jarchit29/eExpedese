...
function OfferedToOthers() {
  ...
  let getOfferedToOthersBids = async () => {
    let url = `${React_App_Base_URL}/getOfferedToOthersBidsExtended`; //~Staging
  ...
  return (
    <ion-content ref={contentRef} scrollEvents={true}>
      ...
      <div>
        ...
        {/* {status === "success" && displayProperties ? (
...
export default OfferedToOthers;
