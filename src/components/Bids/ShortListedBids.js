...
function ShortListedBids() {
  ...
  let fetchDeclinedBids = async () => {
    let url = `${React_App_Base_URL}/getApplicantShortlistedBidsExtended`; //~Staging
...
export default ShortListedBids;
