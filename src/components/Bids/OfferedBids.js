...
function OfferedBids() {
  ...
  let fetchOfferedBids = async () => {
    let url = `${React_App_Base_URL}/getApplicantOfferedBids`; //~Staging
  ...
  const { error, data, status } = useQuery("getofferedbids", fetchOfferedBids, {
    cacheTime: 0,
  });
